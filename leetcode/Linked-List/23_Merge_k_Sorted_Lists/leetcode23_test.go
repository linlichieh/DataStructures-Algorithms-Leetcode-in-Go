	...
	cases := []struct {
		...
		},
		{
			input: []*ListNode{
				...
				&ListNode{Val: 1, Next: &ListNode{Val: 3, Next: &ListNode{Val: 4}}},
				&ListNode{Val: 2, Next: &ListNode{Val: 6}},
				&ListNode{Val: 3, Next: &ListNode{Val: 7, Next: &ListNode{Val: 9}}},
			},
			output: &ListNode{Val: 1, Next: &ListNode{Val: 1, Next: &ListNode{Val: 2, Next: &ListNode{Val: 3, Next: &ListNode{Val: 3, Next: &ListNode{Val: 4, Next: &ListNode{Val: 4, Next: &ListNode{Val: 5, Next: &ListNode{Val: 6, Next: &ListNode{Val: 7, Next: &ListNode{Val: 9}}}}}}}}}}},
		},
		{
			input:  []*ListNode{},
			output: nil,
